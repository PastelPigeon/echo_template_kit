(function (Scratch) {
  ...
  const iconURIs = {
    ...
    getCostumeIndex: "data:application/octet-stream;base64,",
  ...
  class RalseiMagicTools {
    ...
    findStageCanvas() {
      // 尝试多种方式查找舞台canvas
      return document.querySelector('canvas.stage-wrapper') ||
