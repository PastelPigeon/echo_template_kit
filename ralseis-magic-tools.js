(function (Scratch) {
  ...
  const iconURIs = {
    ...
    getCostumeIndex: "data:image/png;base64,",
  ...
  class RalseiMagicTools {
      ...
      return {
        ...
        blocks: [
          ...
          },
          {
            opcode: 'parseBBCode',
            blockType: Scratch.BlockType.REPORTER,
            text: '解析BBCode字符串 [BBCODE] 为token数组',
            blockIconURI: iconURIs.parseBBCode,
            arguments: {
              BBCODE: {
                type: Scratch.ArgumentType.STRING,
                defaultValue: '[b]粗体[/b]文本[i]斜体[/i]'
              }
            }
          },
          {
    ...
    parseBBCode(args) {
      const bbcode = Scratch.Cast.toString(args.BBCODE);
      return JSON.stringify(this.parseBBCodeToTokens(bbcode));
    }
